...
const AdminSidebar: React.FC<{ sidebarOpen: boolean; setSidebarOpen: (open: boolean) => void }> = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    const navItems = [
        ...
        { to: '/users', icon: icons.users, label: 'Manajemen Pengguna' },
    ];
    
    const sidebarContent = (
      <div className="flex flex-col h-full bg-white p-4 border-r border-slate-200">
        <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-bold text-brand-pink-600">Admin Panel</h1>
            </div>
        ...
        <div className="mt-auto space-y-2">
            <NavItem to="/profile" icon={icons.profile} label="Profil" onClick={() => setSidebarOpen(false)} />
            <button
